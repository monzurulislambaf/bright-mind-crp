...
export default async function SolicitorPortalPage() {
    ...
    <div className="mx-auto w-full max-w-6xl px-4 py-8">
      <div className="mb-8 flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-base-content/70">{person.name} — your firm&apos;s instructions.</p>
        </div>
        <Link href="/portal/solicitor/new" className="btn btn-primary">
          New Instruction
        </Link>
      </div>
      ...
      <div className="mt-10">
        <h2 className="mb-4 text-xl font-semibold">Firm cases</h2>
